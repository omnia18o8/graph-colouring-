Below is an academic project summarizing my dissertation on the **Asymmetric Palette Sparsification (APS)** algorithm.
The report outlines the algorithm’s motivation, methodology, results, implications, and conclusions.

---

**Asymmetric Palette Sparsification (APS) Algorithm**

---

**1. Introduction**

This dissertation investigates the **Asymmetric Palette Sparsification (APS)** algorithm — a graph-theoretic approach for efficient colouring in streaming and distributed settings.
...
The dissertation formalizes the APS model by defining:
...
In dense graphs, APS maintained strong accuracy using only **O(n log^2 n)** bits of memory, validating its space–accuracy trade-off.
...
This dissertation establishes **Asymmetric Palette Sparsification** as an efficient, scalable alternative to classical graph colouring.
...
Main outcome is producing a high-probability colourability with sublinear memory usage.
